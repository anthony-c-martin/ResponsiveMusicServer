System.register(['../services/api/api.module', '../services/session/session.module', '../services/playlist/playlist.module'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var api_module_1, session_module_1, playlist_module_1;
    return {
        setters:[
        ...
        execute: function() {
            exports_1("default",angular.module('app.core', [
