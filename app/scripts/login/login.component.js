System.register(['angular2/core', 'blueimp-md5', 'angular2/router', '../services/api/api.service', '../services/error/error.service', '../services/session/session.service'], function(exports_1, context_1) {
    "use strict";
